...
/**
 * ClassName: Transform_AddImageWatermarkToPDF
 * Package: org.example
 * Description:
 *
 * @Author: 闫守瑞
 * @Create: 2023/9/23 - 9:10
 * @Version: v1.0
 */
public class Transform_AddImageWatermarkToPDF {
    public static void main(String[] args) {
        ...
        try {
            ...
            for (int i = 1; i <= numPages; i++) {
                ...
                watermarkImage.setRotationAngle(Math.PI / 4); // 设置旋转角度为45度
